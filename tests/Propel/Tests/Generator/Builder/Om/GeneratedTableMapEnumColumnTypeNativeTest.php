...
<database name="generated_object_complex_type_test_104">
    <table name="complex_column_type_entity_104">
        ...
        <column name="bar" type="ENUM" valueSet="foo, bar, baz, 1, 4,(, foo bar " sqlType="ENUM('foo', 'bar', 'baz', '1', '4', '(', 'foo bar')" />
    </table>
</database>
EOF;
    ...
    {
        $expected = array(\Map\ComplexColumnTypeEntity104TableMap::COL_BAR => array('foo', 'bar',
            'baz', '1', '4', '(', 'foo bar'));
